...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_projects_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_projects_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_projects_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__projects_v_version_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__projects_v_version_links_link_appearance" AS ENUM('default', 'outline');
  ...
  CREATE TABLE IF NOT EXISTS "projects_links" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_projects_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_projects_links_link_appearance" DEFAULT 'default'
  );
  ...
  CREATE TABLE IF NOT EXISTS "_projects_v_version_media" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_projects_v_version_links" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"link_type" "enum__projects_v_version_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum__projects_v_version_links_link_appearance" DEFAULT 'default',
  	"_uuid" varchar
  );
  ...
  DO $$ BEGIN
   ALTER TABLE "projects_media" ADD CONSTRAINT "projects_media_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_projects_v_version_media" ADD CONSTRAINT "_projects_v_version_media_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "projects_media_order_idx" ON "projects_media" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "projects_media_parent_id_idx" ON "projects_media" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "projects_media_image_idx" ON "projects_media" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_projects_v_version_media_order_idx" ON "_projects_v_version_media" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_projects_v_version_media_parent_id_idx" ON "_projects_v_version_media" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_projects_v_version_media_image_idx" ON "_projects_v_version_media" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_projects_v_texts_order_parent_idx" ON "_projects_v_texts" USING btree ("order","parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_projects_links_link_appearance";
  DROP TYPE "public"."enum_projects_status";
  DROP TYPE "public"."enum__projects_v_version_links_link_type";
  DROP TYPE "public"."enum__projects_v_version_links_link_appearance";
