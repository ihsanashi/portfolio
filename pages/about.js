            ...
            <section className='my-36 grid grid-cols-12 gap-5'>
              ...
              <div className='col-span-7'>
                <h5 className='text-2xl text-gray-800 font-sans leading-relaxed'>
                  ...
                  tempore, a aliquid quam cum iure sequi itaque repellat
                  quibusdam voluptas iste facilis.
                </h5>
                <h5 className='text-2xl text-gray-800 font-sans leading-relaxed mt-8'>
                  ...
                  dolores, explicabo, quia cumque eius voluptatibus libero
                  placeat repellendus laborum? Alias, ratione architecto.
                </h5>
              </div>
            </section>
            {/* end: hero */}
